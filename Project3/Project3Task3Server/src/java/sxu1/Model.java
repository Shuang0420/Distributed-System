...
//            System.out.println("res " + javax.xml.bind.DatatypeConverter.printHexBinary(res));
     ...
     * @return report
     */
    public String highTemperature(String sensorID,
            String timeStamp, String type, String temperature, String signature) {
     ...
     * @return report
     */
    public String lowTemperature(String sensorID,
            String timeStamp, @WebParam(name = "type") String type, String temperature, String signature) {
        String mes = sensorID + timeStamp + type + temperature;
        if (!checkValid(sensorID, mes, signature)) {
            return "Invalid signature method!";
        }
